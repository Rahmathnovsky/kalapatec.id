...
<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs mb-3">
            ...
            <li class="separator"><i class="icon-arrow-right"></i></li>
            <li class="nav-item"><a href="{{ route('post.index') }}">Article</a></li>
            <li class="separator"><i class="icon-arrow-right"></i></li>
            <li class="nav-item"><a href="{{ route('post.create') }}">Create</a></li>
        </ul>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <div id="hashtags-list" class="d-flex flex-wrap gap-1 mt-2"></div>
